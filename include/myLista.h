	...
	private:
		...
		*/
		struct myNode
		{
			...
			myNode* anterior; /**< Ponteiro para o nó anterior (no sentido do fim) da lista */
		...
		myNode *sentinela_tail;	/**< Ponteiro para o nó depois do fim da lista */
		//myNode *after_tail;	/**< Ponteiro para o nó do fim da lista */
